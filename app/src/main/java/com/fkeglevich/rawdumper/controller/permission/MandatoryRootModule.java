...
public class MandatoryRootModule extends MandatoryPermissionModule
{
    public MandatoryRootModule(ActivityReference activityReference)
    {
    ...
    {
        return new MandatoryRootManager();
    }
}
