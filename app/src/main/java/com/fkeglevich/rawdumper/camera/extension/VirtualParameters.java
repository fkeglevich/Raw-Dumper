...
{
    public static final Parameter<PictureMode> PICTURE_MODE = ParameterFactory.create("picture-mode", PictureMode.class);
    public static final Parameter<PictureFormat> PICTURE_FORMAT = ParameterFactory.create("picture-format", PictureFormat.class);
}
