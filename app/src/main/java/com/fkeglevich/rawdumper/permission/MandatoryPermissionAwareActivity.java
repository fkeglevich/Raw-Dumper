...
public abstract class MandatoryPermissionAwareActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mandatoryPermissionManager = new MandatoryPermissionManager(getPermissionResultListener());
    }
    ...
    protected abstract IPermissionResultListener getPermissionResultListener();
}
