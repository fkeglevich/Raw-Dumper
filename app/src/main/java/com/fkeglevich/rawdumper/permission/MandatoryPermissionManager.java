...
import com.fkeglevich.rawdumper.util.NameNotFoundFromItselfException;
...
class MandatoryPermissionManager
{
    ...
    protected void allPermissionsWereGranted()
    {
        if (permissionResultListener != null)
            permissionResultListener.onAllPermissionsGranted();
    }

    protected void missingPermissions()
    {
        if (permissionResultListener != null)
