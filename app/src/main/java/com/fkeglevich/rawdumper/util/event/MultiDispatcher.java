...
public class MultiDispatcher<T extends Enum<T>> implements EventDispatcher<T>
{

    public MultiDispatcher(Class<T> eventType)
    {
    ...
    public void dispatchEvent(T data, Object extraData) {
